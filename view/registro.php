                    ...
                    <form action="" method="post" class="login-form">
                        ...
                        if (!empty($mensaje)) {
                            ...
                            foreach ($mensaje as $mensaje) {
                                echo '<p>  <i class="fa-solid fa-triangle-exclamation"> </i> ' . $mensaje . '</p>';
                            }
                            echo '</div>';
                        }
                        ?>
                        <?php
                        // Imprimir mensajes de cuando se registre correctamente
                        if (!empty($mensaje2)) {
                            echo '<div class="alert alert-success role="alert"">
                         
                
                            ';
                            foreach ($mensaje2 as $mensaje2) {
                                echo '<p>  <i class="fa-solid fa-circle-check"></i> ' . $mensaje2 . '</p>';
                            }
                            echo '</div>';
                        }
                        ?>
                        ...
                        <!--input 2-->
                        <div class="form-floating mb-4">
                            <input type="text" name="usuario" class="form-control font-weight-bold" id="floatingInput" placeholder="name@example.com " required>
                            <label for="floatingInput">Usuario </label>
                        </div>
                        <!--input 3-->
                        <div class="form-floating mb-4">
                            <input type="email" name="correo" class="form-control font-weight-bold" id="floatingInput" placeholder="name@example.com" required>
                        ...
                        <!--input 4-->
                        <div class="form-floating mb-4">
                            <input type="password" name="confirma_contraseña" class="form-control font-weight-bold mb-2" id="floatingPassword" placeholder="Password" required>
                            <label for="floatingPassword ">Contraseña</label>
                        ...
                        <div class="mb-4 form-check"> <!-- para mantener la seccion activa-->
                            <input type="checkbox" name="connected" class="form-check-input" id="" required />
